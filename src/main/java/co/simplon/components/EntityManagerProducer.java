...
//	private static String DEFAULT_JDBC_URL = "jdbc:h2:file:~/db/referentiel";
	private static String DEFAULT_JDBC_URL = "jdbc:h2:tcp://localhost/C:\\Users\\Utilisateur-SJD\\courses\\db\\data\\referentiel";
